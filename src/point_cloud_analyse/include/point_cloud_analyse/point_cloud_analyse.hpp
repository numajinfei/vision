...
private:
  ...
  /**
  * @brief this part is for accuracy testing
  */
  float _straightness_z_l;
  float _straightness_z_h;
  float _planeflatness_z_l;
  float _planeflatness_z_h;
  float _planeflatness_x_l;
  float _planeflatness_x_h;

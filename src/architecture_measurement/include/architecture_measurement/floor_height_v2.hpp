...
class FloorHeight : public rclcpp::Node
{
    ...
    private:
        ...
        void _SubPointCloud(shared_interfaces::msg::PointCloudOp::UniquePtr ptr);
    ...
    private:
        ...
        // std::vector<double> vertical_distance;
        ...
        rclcpp::Subscription<shared_interfaces::msg::PointCloudOp>::SharedPtr _subPointCloud;

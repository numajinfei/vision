...
def generate_launch_description():
    ...
    configFile = os.path.join(
        ...
        'config',
        'perpendicularity_and_levelness_params.yaml')

    with open(configFile, 'r') as file:
        configParams = yaml.safe_load(file)['perpendicularity_and_levelness_node']['ros__params']

    node = ComposableNode(
        package = 'architecture_measurement',
        plugin = 'am::PerpendicularityAndLevelness',
        name = 'perpendicularity_and_levelness_node',
        remappings = [
    ...
    container = ComposableNodeContainer(
        name = 'perpendicularity_and_levelness_container',
        namespace = '',
